...
public class MainPageFragment extends Fragment {
    ...
    private MainPageFilteredAdapter adapterFiltered;
    private Set<String> gameNameSet;
    RecyclerView recyclerView;
    SearchView searchView;
    Bundle bundleFiltered;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapterFiltered = new MainPageFilteredAdapter(new MainPageFilteredAdapter.WordDiff());
        ...
        viewModel.getGameFromDatabase().observe(getViewLifecycleOwner(), games -> {
            ...
            adapterFiltered.setGameName(gameNameSet);
        });


        bundleFiltered = this.getArguments();
        if (bundleFiltered == null || bundleFiltered.getString("genre") == "Жанры") {
            ...
            adapter.setListenerFav((flag, element) -> {
                FavouriteEntity game = new FavouriteEntity(element.getName().toLowerCase(), element.getId(), element.getHeader_image(),
                        Integer.toString(element.getDiscount_percent()), element.getOriginal_price() / 100);
                if (flag) {
            ...
            adapterFiltered.setListenerElement(element -> {
                Bundle bundle = new Bundle();
            ...
            adapterFiltered.setListenerFav((flag, element) -> {
            ...
            viewModel.setFilteredGamesLiveData(bundleFiltered.getString("genre"));

            viewModel.getFilteredGamesLiveData().observe(getViewLifecycleOwner(), games -> {
                adapterFiltered.submitList(games.getProducts());
            });
    ...
    private void filterRecycle(String text) {
        if (text.isEmpty()) {
            if (bundleFiltered == null || bundleFiltered.getString("genre") == "Жанры") {
                ...
                binding.gamesRecycler.setAdapter(adapterFiltered);
            }
            return;
        }
